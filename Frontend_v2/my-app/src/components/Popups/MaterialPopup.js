...
function MaterialPopup(props) {
	...
	const postData = (e) => {
		...
		if (materialID == null || materialID == "") {
			swal("Error", "Material ID is Empty !", "error", {
				buttons: false,
				timer: 2000,
			});
			return;
		...
		axios
			.post(`${process.env.REACT_APP_API_URL}addMaterial`, formData)
			.then((res) => {
				...
				>
					<form>
						<div className="account-popup">
							<div
								style={{ fontFamily: "Muli", fontSize: "18px" }}
								className="account-imagefield"
							>
